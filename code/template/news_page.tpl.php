...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
    ...
    <body  class="footer-hidden">
        <div id="page">
            ...
            <div class="image-bg content-in" data-background="images/news-.jpg" style="background-position:50% 0%;"></div>
			<div class="overlay"></div>
               ...
               <div class="col-md-12 text-center">
                   <div class="section-title white animated fadeInUp visible" data-animation="fadeInUp">
					...
					<p class="details">News & Events are best way to let people know about coming new events.</p>
