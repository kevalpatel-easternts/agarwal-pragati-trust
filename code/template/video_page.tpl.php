...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
    ...
    <body  class="footer-hidden">
        <div id="page">
            ...
            <div class="image-bg content-in" data-background="images/Video-gallery.jpg" data-stellar-background-ratio="1.0"></div>
			<div class="overlay"></div>
               ...
               <div class="col-md-12 text-center">
                   <div class="section-title white animated fadeInUp visible" data-animation="fadeInUp">
					...
					<p class="details">Video Gallery provides you the best knowledge or information about new things.</p>
