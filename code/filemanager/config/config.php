...
$base_url="http://".$_SERVER['HTTP_HOST']."/bhaktigroup";  // DON'T TOUCH (base url (only domain) of site (without final /)).
...
$ext_file = array('doc', 'docx','rtf', 'pdf', 'xls', 'xlsx', 'ppt','pptx');
...
$ext=array_merge($ext_img, $ext_file, $ext_video,$ext_music); //allowed extensions
