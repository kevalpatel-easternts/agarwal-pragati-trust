...
foreach($gaResults as $result)
{
	...
	$country = '<td><a href=index.php?controller=dashboard&action=details&subaction=listData&source='.$source.'&filter='.$result->getoperatingSystem().'>'.$result->getoperatingSystem().'</a></td>';
