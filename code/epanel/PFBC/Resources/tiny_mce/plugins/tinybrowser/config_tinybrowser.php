...
session_start();
$tinybrowser['sessioncheck'] = 'loginID'; //name of session variable to check
...
$tinybrowser['docroot'] = rtrim($_SERVER['DOCUMENT_ROOT'],'/assignment');

// Folder permissions for Unix servers only
$tinybrowser['unixpermissions'] = 0777;

// File upload paths (set to absolute by default)
$tinybrowser['path']['image'] = '99developers/upload/image/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '99developers/upload/media/'; // Media files location
$tinybrowser['path']['file']  = '99developers/upload/files/'; // Other files location
