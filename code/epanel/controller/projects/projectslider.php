...
<script>
 ...
 Dropzone.options.myDropzone = {
            ...
            success : function(){
                location.href = "index.php?controller=projects&action=projectslider&subaction=listData&projectID=<?php echo $_REQUEST['projectID']; ?>";
            }
...
<?php
	...
	{		
		...
		if(ets_db_num_rows($qry) > 0){
			...
			$form->addElement(new Element_Hidden("action", "projectslider"));
...
$(document).ready(function() {
	var listURL = "helperfunc/projectsliderList.php?projectID=<?php echo (int)$_REQUEST['projectID'];?>";
