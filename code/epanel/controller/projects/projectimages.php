...
<script>
 ...
 Dropzone.options.myDropzone = {
            ...
            success : function(){
                location.href = "index.php?controller=projects&action=projectimages&subaction=listData&projectID=<?php echo $_REQUEST['projectID']; ?>";
            }
...
<?php
	...
	{		
		...
		if(ets_db_num_rows($qry) > 0){
			...
			$form->addElement(new Element_Hidden("action", "projectimages"));
...
$(document).ready(function() {
	var listURL = "helperfunc/projectgalleryList.php?projectID=<?php echo (int)$_REQUEST['projectID'];?>";
